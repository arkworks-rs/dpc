use crate::dpc::{
    delegable_dpc::{AddressPublicKey, DPCPredicate, DelegableDPCComponents},
    Record,
};
use ark_crypto_primitives::{CommitmentScheme, SignatureScheme, CRH};
use ark_ff::to_bytes;
...
pub struct DPCRecord<C: DelegableDPCComponents> {
...
impl<C: DelegableDPCComponents> Record for DPCRecord<C> {
